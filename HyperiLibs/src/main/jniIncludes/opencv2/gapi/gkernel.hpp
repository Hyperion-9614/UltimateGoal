...
namespace cv {
    namespace gapi {
        ...
        class GAPI_EXPORTS_W_SIMPLE GKernelPackage
                {
                        ...
                        {
                            m_id_kernels[functor.id()] = std::make_pair(functor.backend(),
                                                                        functor.impl());
                        }
                        /**
        ...
        combine(const GKernelPackage &lhs,
                const GKernelPackage &rhs);

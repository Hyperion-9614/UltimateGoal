...
namespace gapi {
    namespace wip {
        ...
        */
        GAPI_EXPORTS void
        async(GCompiled &gcmpld, std::function<void(std::exception_ptr)> &&callback, GRunArgs &&ins,
              GRunArgsP &&outs);
        ...
        */
        GAPI_EXPORTS void
        async(GCompiled &gcmpld, std::function<void(std::exception_ptr)> &&callback, GRunArgs &&ins,
              GRunArgsP &&outs, GAsyncContext &ctx);
        ...
        @see async
        */
        GAPI_EXPORTS std::future<void>
        async(GCompiled
        & gcmpld,
        GRunArgs &&ins, GRunArgsP
        &&outs);

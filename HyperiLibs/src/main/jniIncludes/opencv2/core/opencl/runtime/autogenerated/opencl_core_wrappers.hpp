...
inline cl_int
clBuildProgram(cl_program p0, cl_uint p1, const cl_device_id *p2, const char *p3, void (CL_CALLBACK
...
inline cl_int
clCompileProgram(cl_program p0, cl_uint p1, const cl_device_id *p2, const char *p3, cl_uint p4,
                 const cl_program *p5, const char **p6, void (CL_CALLBACK
...
inline cl_memclCreateBuffer(cl_context p0, cl_mem_flags p1, size_t p2, void *p3,
                            cl_int *p4) { return clCreateBuffer_pfn(p0, p1, p2, p3, p4); }

#undef clCreateCommandQueue
#define clCreateCommandQueue clCreateCommandQueue_fn

inline cl_command_queue
clCreateCommandQueue(cl_context p0, cl_device_id p1, cl_command_queue_properties p2,
                     cl_int *p3) { return clCreateCommandQueue_pfn(p0, p1, p2, p3); }

#undef clCreateContext
#define clCreateContext clCreateContext_fn

inline cl_context
clCreateContext(const cl_context_properties *p0, cl_uint p1, const cl_device_id *p2,
                void (CL_CALLBACK

*p3) (const char*, const void*, size_t, void*),
void *p4, cl_int
* p5) {
return
...
inline cl_context
clCreateContextFromType(const cl_context_properties *p0, cl_device_type p1, void (CL_CALLBACK

*p2) (const char*, const void*, size_t, void*),
void *p3, cl_int
* p4) {
return
...
inline cl_mem
clCreateImage(cl_context p0, cl_mem_flags p1, const cl_image_format *p2, const cl_image_desc *p3,
              void *p4, cl_int *p5) { return clCreateImage_pfn(p0, p1, p2, p3, p4, p5); }

#undef clCreateImage2D
#define clCreateImage2D clCreateImage2D_fn

inline cl_mem
clCreateImage2D(cl_context p0, cl_mem_flags p1, const cl_image_format *p2, size_t p3, size_t p4,
...
inline cl_mem
clCreateImage3D(cl_context p0, cl_mem_flags p1, const cl_image_format *p2, size_t p3, size_t p4,
...
inline cl_program
clCreateProgramWithBinary(cl_context p0, cl_uint p1, const cl_device_id *p2, const size_t *p3,
...
inline cl_program
clCreateProgramWithBuiltInKernels(cl_context p0, cl_uint p1, const cl_device_id *p2, const char *p3,
                                  cl_int *p4) {
...
inline cl_intclCreateSubDevices(cl_device_id p0, const cl_device_partition_property *p1, cl_uint p2,
...
inline cl_intclEnqueueBarrierWithWaitList(cl_command_queue p0, cl_uint p1, const cl_event *p2,
                                          cl_event *p3) {
...
inline cl_int
clEnqueueCopyBuffer(cl_command_queue p0, cl_mem p1, cl_mem p2, size_t p3, size_t p4, size_t p5,
...
inline cl_intclEnqueueCopyBufferRect(cl_command_queue p0, cl_mem p1, cl_mem p2, const size_t *p3,
                                     const size_t *p4, const size_t *p5, size_t p6, size_t p7,
                                     size_t p8, size_t p9, cl_uint p10, const cl_event *p11,
                                     cl_event *p12) {
...
inline cl_int
clEnqueueCopyBufferToImage(cl_command_queue p0, cl_mem p1, cl_mem p2, size_t p3, const size_t *p4,
...
inline cl_int
clEnqueueCopyImage(cl_command_queue p0, cl_mem p1, cl_mem p2, const size_t *p3, const size_t *p4,
                   const size_t *p5, cl_uint p6, const cl_event *p7, cl_event *p8) {
...
inline cl_intclEnqueueCopyImageToBuffer(cl_command_queue p0, cl_mem p1, cl_mem p2, const size_t *p3,
                                        const size_t *p4, size_t p5, cl_uint p6, const cl_event *p7,
                                        cl_event *p8) {
...
inline cl_int
clEnqueueFillBuffer(cl_command_queue p0, cl_mem p1, const void *p2, size_t p3, size_t p4, size_t p5,
                    cl_uint p6, const cl_event *p7, cl_event *p8) {
...
inline cl_intclEnqueueFillImage(cl_command_queue p0, cl_mem p1, const void *p2, const size_t *p3,
...
inline void *
clEnqueueMapBuffer(cl_command_queue p0, cl_mem p1, cl_bool p2, cl_map_flags p3, size_t p4,
...
inline void *
clEnqueueMapImage(cl_command_queue p0, cl_mem p1, cl_bool p2, cl_map_flags p3, const size_t *p4,
                  const size_t *p5, size_t *p6, size_t *p7, cl_uint p8, const cl_event *p9,
...
inline cl_intclEnqueueMarkerWithWaitList(cl_command_queue p0, cl_uint p1, const cl_event *p2,
                                         cl_event *p3) {
...
inline cl_intclEnqueueMigrateMemObjects(cl_command_queue p0, cl_uint p1, const cl_mem *p2,
                                        cl_mem_migration_flags p3, cl_uint p4, const cl_event *p5,
                                        cl_event *p6) {
...
inline cl_intclEnqueueNDRangeKernel(cl_command_queue p0, cl_kernel p1, cl_uint p2, const size_t *p3,
                                    const size_t *p4, const size_t *p5, cl_uint p6,
...
inline cl_int clEnqueueNativeKernel(cl_command_queue p0, void (CL_CALLBACK
...
cl_uint p4,
const cl_mem *p5,
const void **p6, cl_uint
p7,
const cl_event *p8, cl_event
* p9) {
return
...
inline cl_int
clEnqueueReadBuffer(cl_command_queue p0, cl_mem p1, cl_bool p2, size_t p3, size_t p4, void *p5,
                    cl_uint p6, const cl_event *p7, cl_event *p8) {
...
inline cl_intclEnqueueReadBufferRect(cl_command_queue p0, cl_mem p1, cl_bool p2, const size_t *p3,
                                     const size_t *p4, const size_t *p5, size_t p6, size_t p7,
                                     size_t p8, size_t p9, void *p10, cl_uint p11,
...
inline cl_int
clEnqueueReadImage(cl_command_queue p0, cl_mem p1, cl_bool p2, const size_t *p3, const size_t *p4,
...
inline cl_int
clEnqueueUnmapMemObject(cl_command_queue p0, cl_mem p1, void *p2, cl_uint p3, const cl_event *p4,
                        cl_event *p5) {
...
inline cl_intclEnqueueWriteBuffer(cl_command_queue p0, cl_mem p1, cl_bool p2, size_t p3, size_t p4,
...
inline cl_intclEnqueueWriteBufferRect(cl_command_queue p0, cl_mem p1, cl_bool p2, const size_t *p3,
                                      const size_t *p4, const size_t *p5, size_t p6, size_t p7,
                                      size_t p8, size_t p9, const void *p10, cl_uint p11,
                                      const cl_event *p12, cl_event *p13) {
...
inline cl_int
clEnqueueWriteImage(cl_command_queue p0, cl_mem p1, cl_bool p2, const size_t *p3, const size_t *p4,
                    size_t p5, size_t p6, const void *p7, cl_uint p8, const cl_event *p9,
                    cl_event *p10) {
...
inline cl_intclGetContextInfo(cl_context p0, cl_context_info p1, size_t p2, void *p3,
                              size_t *p4) { return clGetContextInfo_pfn(p0, p1, p2, p3, p4); }

#undef clGetDeviceIDs
#define clGetDeviceIDs clGetDeviceIDs_fn

inline cl_intclGetDeviceIDs(cl_platform_id p0, cl_device_type p1, cl_uint p2, cl_device_id *p3,
                            cl_uint *p4) { return clGetDeviceIDs_pfn(p0, p1, p2, p3, p4); }

#undef clGetDeviceInfo
#define clGetDeviceInfo clGetDeviceInfo_fn

inline cl_intclGetDeviceInfo(cl_device_id p0, cl_device_info p1, size_t p2, void *p3,
                             size_t *p4) { return clGetDeviceInfo_pfn(p0, p1, p2, p3, p4); }

#undef clGetEventInfo
#define clGetEventInfo clGetEventInfo_fn
inline cl_int clGetEventInfo(cl_event
p0,
cl_event_info p1, size_t
p2,
void *p3, size_t
* p4) {
return
...
inline cl_int clGetEventProfilingInfo(cl_event
p0,
cl_profiling_info p1, size_t
p2,
void *p3, size_t
* p4) {
return
...
inline void *
clGetExtensionFunctionAddress(const char *p0) { return clGetExtensionFunctionAddress_pfn(p0); }
...
inline cl_intclGetImageInfo(cl_mem p0, cl_image_info p1, size_t p2, void *p3,
                            size_t *p4) { return clGetImageInfo_pfn(p0, p1, p2, p3, p4); }
...
inline cl_intclGetKernelInfo(cl_kernel p0, cl_kernel_info p1, size_t p2, void *p3,
                             size_t *p4) { return clGetKernelInfo_pfn(p0, p1, p2, p3, p4); }

#undef clGetKernelWorkGroupInfo
#define clGetKernelWorkGroupInfo clGetKernelWorkGroupInfo_fn

inline cl_int
clGetKernelWorkGroupInfo(cl_kernel p0, cl_device_id p1, cl_kernel_work_group_info p2, size_t p3,
                         void *p4, size_t *p5) {
...
inline cl_intclGetMemObjectInfo(cl_mem p0, cl_mem_info p1, size_t p2, void *p3,
                                size_t *p4) { return clGetMemObjectInfo_pfn(p0, p1, p2, p3, p4); }

#undef clGetPlatformIDs
#define clGetPlatformIDs clGetPlatformIDs_fn
inline cl_int clGetPlatformIDs(cl_uint
p0,
cl_platform_id *p1, cl_uint
* p2) {
return
...
inline cl_intclGetPlatformInfo(cl_platform_id p0, cl_platform_info p1, size_t p2, void *p3,
                               size_t *p4) { return clGetPlatformInfo_pfn(p0, p1, p2, p3, p4); }

#undef clGetProgramBuildInfo
#define clGetProgramBuildInfo clGetProgramBuildInfo_fn

inline cl_int
clGetProgramBuildInfo(cl_program p0, cl_device_id p1, cl_program_build_info p2, size_t p3, void *p4,
                      size_t *p5) { return clGetProgramBuildInfo_pfn(p0, p1, p2, p3, p4, p5); }

#undef clGetProgramInfo
#define clGetProgramInfo clGetProgramInfo_fn

inline cl_intclGetProgramInfo(cl_program p0, cl_program_info p1, size_t p2, void *p3,
                              size_t *p4) { return clGetProgramInfo_pfn(p0, p1, p2, p3, p4); }

#undef clGetSamplerInfo
#define clGetSamplerInfo clGetSamplerInfo_fn

inline cl_intclGetSamplerInfo(cl_sampler p0, cl_sampler_info p1, size_t p2, void *p3,
                              size_t *p4) { return clGetSamplerInfo_pfn(p0, p1, p2, p3, p4); }

#undef clGetSupportedImageFormats
#define clGetSupportedImageFormats clGetSupportedImageFormats_fn

inline cl_int
clGetSupportedImageFormats(cl_context p0, cl_mem_flags p1, cl_mem_object_type p2, cl_uint p3,
...
inline cl_program
clLinkProgram(cl_context p0, cl_uint p1, const cl_device_id *p2, const char *p3, cl_uint p4,
              const cl_program *p5, void (CL_CALLBACK
...
inline cl_int clReleaseEvent(cl_event
p0) {
return
...
inline cl_int clRetainEvent(cl_event
p0) {
return
...
inline cl_int clSetEventCallback(cl_event
p0,
cl_int p1,
void (CL_CALLBACK
*p2) (cl_event, cl_int, void*),
void *p3
) {
return
...
inline cl_intclSetKernelArg(cl_kernel p0, cl_uint p1, size_t p2, const void *p3) {
...
inline cl_int clSetMemObjectDestructorCallback(cl_mem p0, void (CL_CALLBACK
...
inline cl_int clSetUserEventStatus(cl_event
p0,
cl_int p1
) {
return
...
inline cl_int clWaitForEvents(cl_uint
p0,
const cl_event *p1
) {
return

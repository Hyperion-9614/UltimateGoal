...
if __name__ == "__main__":
    # Tune the values to filter out as much noise as possible while making sure rings are 100% not cut
    # Can be rough, 2nd filter automatically picks up any discrepancies

                ...
                struct Text {
                    ...
                    Text(const std::string &text_,
                         ...
                         bool bottom_left_origin_ = false) :
                            ...
                            color(color_), thick(thick_), lt(lt_),
 ...
 */
                struct Circle {
                    ...
                    Circle(const cv::Point &center_,
                           ...
                           int lt_ = 8,
                           int shift_ = 0) :
                            center(center_), radius(radius_), color(color_), thick(thick_), lt(lt_),
                            shift(shift_) {
                    }
                ...
                struct Line {
                    ...
                    */
                    Line(const cv::Point &pt1_,
                         ...
                         int lt_ = 8,
                         int shift_ = 0) :
                            pt1(pt1_), pt2(pt2_), color(color_), thick(thick_), lt(lt_),
                            shift(shift_) {
                    }
 ...
 */
                ...
                using Prim = util::variant
                        <Text, FText, Rect, Circle, Line, Mosaic, Image, Poly
                        >;
